...
declare function DataTableView<T extends RowData>({ cellProps, filtering, grouping, loading, loadingOffset, pinning, rowProps, sorting, table, tableProps, tableStyle, viewRef, }: DataTableViewProps<T>): JSX.Element;
