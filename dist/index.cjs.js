...
const PageSelector = ({ requestedPage, setRequestedPage, table, }) => {
    const [localRequestedPage, setLocalRequestedPage] = React.useState(1);
...
function DataTableView({ cellProps, filtering, grouping, loading, loadingOffset, pinning, rowProps, sorting, table, tableProps, viewRef, }) {
    return (React__default["default"].createElement("div", { ref: viewRef, style: {
...
function BootstrapTable({ cellProps, filtering = true, footer = undefined, grouping = true, loading, loadingOffset, pinning = true, requestedPage, rowProps, setRequestedPage, sorting = true, table, tableProps, viewRef, }) {
    return table ? (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(DataTableView, { cellProps: cellProps, filtering: filtering, grouping: grouping, loading: loading, loadingOffset: loadingOffset, pinning: pinning, rowProps: rowProps, sorting: sorting, table: table, tableProps: tableProps, viewRef: viewRef }),
